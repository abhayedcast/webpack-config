...
GmXt.conf.version = "2021.01.30.3";
GmXt.conf.env = "Stage";
...
GmXt.setConfig = function() {
	...
	GmXt.conf.analyticsPortalUrl = "https://stageanalytics.guideme.io/v3/";
...
GmXt.conf.appConfig = {
	login: { guideme: 1, edcast: 1, edToken : 1, signUp: 0, forgotPass: 1 },
	requireLogin: true,
